...
<head>
  ...
  <title>@yield('title','GKKA INDONESIA')</title>

  @php
    $metaSiteName = config('app.name', 'GKKA INDONESIA');
    $seo = config('seo', []);
    $homeUrl = rtrim(url('/'), '/');
...
<body class="site-public min-h-screen min-h-[100svh] flex flex-col overflow-x-hidden @yield('body_class')">

@include('components.navbar')

<main class="site-public-main flex-1">
  @yield('content')
</main>
