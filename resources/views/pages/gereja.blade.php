...
<section class="bg-blue-900 text-white py-14 sm:py-20">
  <div class="gkka-container text-center">
    <h1 class="text-3xl sm:text-4xl md:text-5xl font-black mb-4 tracking-tight">Tentang Gereja</h1>
    <p class="text-base sm:text-lg text-blue-200 font-medium">Mengenal lebih dekat GKKA Indonesia Jemaat Samarinda.</p>
  </div>
</section>
...
<section class="py-12 sm:py-20 bg-gray-50">
  <div class="gkka-container">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <a href="{{ route('gereja.sejarah') }}" class="group bg-white p-6 sm:p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center">
      ...
      <a href="{{ route('gereja.hamba') }}" class="group bg-white p-6 sm:p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center">
        <div class="w-16 h-16 sm:w-20 sm:h-20 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center text-4xl mb-6 group-hover:bg-blue-600 group-hover:text-white transition-colors shadow-sm">
      ...
      <a href="{{ route('gereja.majelis') }}" class="group bg-white p-6 sm:p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center">
        <div class="w-16 h-16 sm:w-20 sm:h-20 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center text-4xl mb-6 group-hover:bg-blue-600 group-hover:text-white transition-colors shadow-sm">
      ...
      <a href="{{ route('gereja.komisi') }}" class="group bg-white p-6 sm:p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center">
        <div class="w-16 h-16 sm:w-20 sm:h-20 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center text-4xl mb-6 group-hover:bg-blue-600 group-hover:text-white transition-colors shadow-sm">
